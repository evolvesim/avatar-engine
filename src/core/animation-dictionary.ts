...
export const ANIMATION_MANIFEST: Record<string, Omit<AnimationEntry, 'clip'>> = {
  ...
  // ── Pack 5 — MoCap Central Male (mc_m) ──────────────────────────────────────
  // Idles (loop)
  ...
  'mc_m_listen_01_neutral':                  { emotion: 'neutral',       loop: THREE.LoopRepeat, defaultCrossfade: 0.5 },
  'mc_m_listen_02_positive':                 { emotion: 'joy',           loop: THREE.LoopRepeat, defaultCrossfade: 0.5 },
  'mc_m_listen_03_negative':                 { emotion: 'sadness',       loop: THREE.LoopRepeat, defaultCrossfade: 0.5 },
  'mc_m_listen_04_neutral':                  { emotion: 'neutral',       loop: THREE.LoopRepeat, defaultCrossfade: 0.5 },
  // Talk (once)
  'mc_m_talk_01_neutral':                    { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_02_neutral':                    { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_03_neutral':                    { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_04_neutral':                    { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_05_positive':                   { emotion: 'joy',           loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_06_negative':                   { emotion: 'sadness',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_07_neutral':                    { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_08_neutral':                    { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_09_neutral':                    { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_01_aneutral_bneutral':          { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_02_aneutral_bnegative':         { emotion: 'sadness',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_03_aneutral_bpositive':         { emotion: 'joy',           loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_04_aneutral_bnegative':         { emotion: 'sadness',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_05_apositive_bpositive':        { emotion: 'joy',           loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_06_anegative_bnegative':        { emotion: 'anger',         loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_07_aneutral_bnegative':         { emotion: 'sadness',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_08_aneutral_bneutral':          { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_09_aneutral_bneutral':          { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_10_aneutral_bneutral':          { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_11_aneutral_bneutral':          { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_12_agestureright_blisten':      { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_13_alisten_bgestureleft':       { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_14_agestureleft_blisten':       { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_15_alisten_bgestureright':      { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_16_agestureup_blisten':         { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_17_alisten_bgestureup':         { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_18_agesturedown_blisten':       { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_talk_19_alisten_bgesturedown':       { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  // Greetings (once)
  'mc_m_greet_01_shakehands':                { emotion: 'joy',           loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_greet_02_fistbump':                  { emotion: 'joy',           loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_greet_03_highfive':                  { emotion: 'joy',           loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_greet_04_highfive':                  { emotion: 'joy',           loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  // Transitions (once)
  'mc_m_trans_stand':                        { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_trans_stand_02':                     { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_trans_standconv':                    { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_trans_standconv_02':                 { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_trans_standconv_03':                 { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_trans_standconv_04':                 { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_m_trans_atob':                         { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },

  // ── Pack 6 — MoCap Central Female (mc_f) ─────────────────────────────────────
  // Idles (loop)
  'mc_f_idle_01':                            { emotion: 'neutral',       loop: THREE.LoopRepeat, defaultCrossfade: 0.5 },
  'mc_f_listen_01_neutral':                  { emotion: 'neutral',       loop: THREE.LoopRepeat, defaultCrossfade: 0.5 },
  'mc_f_listen_02_neutral':                  { emotion: 'neutral',       loop: THREE.LoopRepeat, defaultCrossfade: 0.5 },
  // Talk (once)
  'mc_f_talk_01_neutral':                    { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_02_negative':                   { emotion: 'sadness',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_03_positive':                   { emotion: 'joy',           loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_04_negative':                   { emotion: 'sadness',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_05_positive':                   { emotion: 'joy',           loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_06_neutral':                    { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_01_aneutral_bneutral':          { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_02_aneutral_bnegative':         { emotion: 'sadness',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_03_aneutral_bpositive':         { emotion: 'joy',           loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_04_aneutral_bnegative':         { emotion: 'sadness',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_05_apositive_bpositive':        { emotion: 'joy',           loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_06_anegative_bnegative':        { emotion: 'anger',         loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_07_aneutral_bnegative':         { emotion: 'sadness',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_08_aneutral_bneutral':          { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_09_aneutral_bneutral':          { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_10_aneutral_bneutral':          { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_11_aneutral_bneutral':          { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_12_agestureright_blisten':      { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_13_alisten_bgestureleft':       { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_14_agestureleft_blisten':       { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_15_alisten_bgestureright':      { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_16_agestureup_blisten':         { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_17_alisten_bgestureup':         { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_18_agesturedown_blisten':       { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_talk_19_alisten_bgesturedown':       { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  // Greetings (once)
  'mc_f_greet_01_shakehands':                { emotion: 'joy',           loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_greet_02_fistbump':                  { emotion: 'joy',           loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_greet_03_highfive':                  { emotion: 'joy',           loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_greet_04_highfive':                  { emotion: 'joy',           loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  // Transitions (once)
  'mc_f_trans_stand':                        { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_trans_stand_02':                     { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_trans_standconv':                    { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
  'mc_f_trans_standconv_02':                 { emotion: 'neutral',       loop: THREE.LoopOnce,   defaultCrossfade: 0.3 },
